prompts =
  helpMessage: "Octobot helps you to be an Internet Of Things Overlord. Here are some commands you can give Octobot:
    * 'Set my credentials'
    * 'list all my devices'
    * 'add a new device'
    * 'Send a message to my device'
    * 'show me my message options for <device type>'"
